...
st.sidebar.title("ASTCAW - Waste Management")
st.sidebar.subheader("Navigate through the information")

# Sidebar options (you can modify these based on your needs)
st.title("Home - ASTCAW")
st.sidebar.success("Select A Page")
st.subheader("Proper Waste Disposal")
